...
UPDATE litigation.lit_party SET answer_filed_date = DATE '2026-01-05' WHERE lit_party_id = :'d1';
UPDATE litigation.lit_party SET answer_filed_date = DATE '2026-03-01' WHERE lit_party_id = :'d2';
UPDATE litigation.lit_party SET answer_filed_date = DATE '2026-06-10' WHERE lit_party_id = :'d3';
UPDATE litigation.lit_party SET answer_filed_date = DATE '2026-02-01' WHERE alignment='plaintiff' AND court_case_id = :'cc';
...
INSERT INTO litigation.scheduling_order (scheduling_order_id, court_case_id, order_type, signed_date,
  affidavit_18001_deadline, discovery_close_date, expert_designation_plaintiff_date)
...
INSERT INTO litigation.lit_party (lit_party_id, court_case_id, person_id, pleaded_name, alignment, answer_filed_date)
...
INSERT INTO litigation.scheduling_order (scheduling_order_id, court_case_id, order_type, signed_date, discovery_close_date, trial_date)
