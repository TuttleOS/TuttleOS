...
7. **Top 10 gaps** — print `LIFECYCLE_BUILD_PLAN.md` §9 in that exact order (do not re-rank)  
...
10. **Next decision** — preview pilot is running; Track A is optional harden (do not merge)
...
**Rescore (2026-08-15, GATE-11 only):** louder coverage warning live. Status stays PARTIAL — does not refuse demand/stage.
...
| 3 CM beta | **Locked 2026-08-15** — Mark (1 CM), stagger, preview+demo | Do **not** merge; pilot on preview URL |
...
**Exit:** met. Known-gaps sheet sent; Mark morning-list smoke passed 2026-08-15.
...
| H-12 | CM ↔ Lit dual-track | PARTIAL | Banner live; tie-breaker open |
| H-13 | Settle → Liens | DEFERRED | Stage 4 |
| H-14 | Liens → closed | DEFERRED | UM/UIM owner open |

---

## Top 10 gaps (print this exact order — canonical: `docs/LIFECYCLE_BUILD_PLAN.md` §9)

Do **not** re-rank from status tables. Do **not** substitute INV-03 or other invariants. Do **not** justify a swap.
...
CM pilot still needs honesty about: incomplete GATE-01 variants, no futures gate, package refuse incomplete, and dual-track calendaring (banner is live; dates do not auto-change).
